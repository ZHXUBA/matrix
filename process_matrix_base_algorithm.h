...
namespace _matrix {
    ...
    void vmat_MatPlus(
        const matrix::VitualMatrix<_Iter>& vmat1,
        const matrix::VitualMatrix<_Iter>& vmat2,
        matrix::VitualMatrix<_Iter>& vmat
    ) {
        typename matrix::VitualMatrix<_Iter>::Decorated_Iterator_t begin =  vmat1.iter();
